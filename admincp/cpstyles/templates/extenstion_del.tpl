...
<div class="address_bar">{$lang['Search_Results']} &raquo;
...
<table width="50%" class="t_style_b" border="0" cellspacing="1" align="center">
	...
	<tr align="center">
		<td class="row1">
			<a href="index.php?page=extension&amp;del=1&amp;start=1&amp;id={$Inf['id']}">{$lang['yes']}</a>
		</td>
		<td class="row1">
			<a href="index.php?page=extension&amp;control=1&amp;main=1">{$lang['no']}</a>
		</td>
	</tr>
</table>

...
{$lang['icons']} &raquo;
 <a href="index.php?page=icon&amp;upload_icons=1&amp;main=1">{$lang['upload_icons']}</a></div>
...
{$lang['the_path_of_this_file_should_be_readable_and_writable']}
				...
				<td class="row1">
			<input name="files_imagespath" type="text" size="40" value="look/images/icons" dir="ltr"/>
		</td>
	</tr>
	<tr align="center">
		<td class="row1" colspan="2">

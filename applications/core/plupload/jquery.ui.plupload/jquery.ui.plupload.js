...
obj.html(
		'<div class="plupload_wrapper">' +
			...
			'</div>' +
			'<input class="app_button PBBButton_verySmall PBBButton_primary ui-state-active plupload_save" value="' + _("Add Files") + '" type="button">' +
		'</div>'
	);
}
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
		 ...
		 $("#PageHead_special").hide();
		 $("#PageHead_special").css('display', 'none');
		 $("#drag_position").show();
		 $("#drag_position").css('display', 'black');
		 location.reload();
		})

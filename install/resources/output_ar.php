...
class installerOutput {
	 ...
	 * @var string
	 */
	public $title = "معالج تثبيت PBBoard";
...
<head>
	...
	<link rel="stylesheet" href="stylesheet_ar.css" type="text/css" />
...
END;
	...
	function print_footer($nextact="")
	{
		...
		if($nextact && $this->openedform)
		{
			...
			echo "\n				<div id=\"next_button\"><input type=\"submit\" class=\"submit_button\" value=\"التالي &raquo;\" /></div><br style=\"clear: both;\" />\n";
			$formend = "</form>";
		}
		else
		{

...
<b><u>{$lang['view_group_username_style']}</u></b></a>
      ...
      <tr>
        <td class="row2" width="50%" valign="top">{$lang['group_is_banned']}</td>
	  ...
	  <tr>
		<td class="row1" width="50%" valign="top">{$lang['view_sections']}</td>
		<td class="row1" width="50%" valign="top">
	  ...
	  <tr>
		<td class="row1" width="50%" valign="top">{$lang['view_subject']}</td>
		<td class="row1" width="50%" valign="top">
      ...
      <tr>
        <td class="row2" width="50%" valign="top">{$lang['download_attach']}</td>
        <td class="row2" width="50%" valign="top">
      ...
      <tr>
        <td class="row2" width="50%" valign="top">{$lang['max_pm']}
        <br />
{$lang['Set_0_for_an_unlimited_number_of_messages']}
     ...
     <tr>
      ...
      <tr>
        <td class="row1" width="50%" valign="top">{$lang['group_use_the_account_security_settings']}</td>
        <td class="row1" width="50%" valign="top">
       ...
       <tr>
        <td class="row1" width="50%" valign="top">{$lang['group_use_profile_photo']}</td>
        <td class="row1" width="50%" valign="top">
